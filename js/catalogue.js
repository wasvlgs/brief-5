        ...
        pageProducts.forEach((product,index) => {
            ...
            productCard.innerHTML = `    
                    <button id="details-button">
                        <img onclick="toDetailProduct(${product.id})" src="${product.image[0]}" alt="${product.name}" class="px-4 object-fill w-screen h-[10vh] mb-4 rounded-[30px] lg:w-screen lg:px-10 lg:h-[35vh]"> 
                    </button>
