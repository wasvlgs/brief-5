  ...
  try {
    ...
    let getIndex;
      ...
      for(i = 0; i < data.length; i++){
        ...
        document.getElementById("product-description").textContent = data[getIndex].description;
        document.getElementById("mainImage").src = data[getIndex].image;
        document.getElementById("supplier").textContent = data[getIndex].SupplierReference;
        ...
        document.getElementById("hard-disk").textContent = data[getIndex].HardDiskCapacity;
        document.getElementById("graphic-card").textContent = data[getIndex].GraphicsCard;
        document.getElementById("design").textContent = data[getIndex].Design;
        document.getElementById("screen-size").textContent = data[getIndex].ScreenSize;
        document.getElementById("operating-system").textContent = data[getIndex].OperatingSystem;
        ...
        openCustomize.onclick = function(){
          if(data[getIndex].category == "laptop" || data[getIndex].category == "computer"  ){
          pcModal.classList.remove("hidden");
        }else if(data[getIndex].category == "phone" || data[getIndex].category == "ipad"){
...
displayInfo();
   ...
   function addTo(){
      ...
      addCardToPanier(getId,getIndexItem)
      }
